...
export interface ApiArticleArticle extends Schema.CollectionType {
  ...
  attributes: {
    ...
    priority: Attribute.Enumeration<['main', 'secondary', 'third', 'regular']> &
      Attribute.Required &
...
export interface ApiMagazineMagazine extends Schema.CollectionType {
  ...
  attributes: {
    ...
    slug: Attribute.UID<'api::magazine.magazine', 'title'> & Attribute.Required;
    publishedDate: Attribute.Date & Attribute.Required & Attribute.Unique;
    magazineEmbedUrl: Attribute.Text &
      Attribute.SetMinMaxLength<{
        minLength: 1;
      }>;
    createdAt: Attribute.DateTime;
...
export interface ApiManagerEmailManagerEmail extends Schema.SingleType {
  collectionName: 'manager_emails';
  info: {
    singularName: 'manager-email';
    pluralName: 'manager-emails';
  ...
  attributes: {
    ...
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::manager-email.manager-email',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::manager-email.manager-email': ApiManagerEmailManagerEmail;
    }
  }
}
